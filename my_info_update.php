...
<html lang="en">
  <head>
    ...
    <form action="my_info_update_ok.php" method="post">
        ...
        <h1 class="h3 mb-3 fw-normal">정보 수정</h1>
        ...
        <div class="form-floating">
        <input name="prepassword" value="" type="password" class="form-control" id="floatingPassword" placeholder="Password">
        <label for="floatingPassword">기존 비밀번호</label>
        </div>
        <div class="form-floating">
        <input name="afterpassword" value="" type="password" class="form-control" id="floatingPassword" placeholder="Password">
        ...
        <button style="margin-bottom: 10px;" class="w-100 btn btn-lg btn-primary" type="submit">수정 완료</button>
    </form>
